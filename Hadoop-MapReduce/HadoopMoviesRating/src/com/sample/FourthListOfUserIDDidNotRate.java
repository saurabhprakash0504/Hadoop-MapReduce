...
public class FourthListOfUserIDDidNotRate {
	...
	public static void main(String[] args) throws Exception {
		...
		job.setJarByClass(FourthListOfUserIDDidNotRate.class);
	...
	static class MapperMovieRating extends Mapper<LongWritable, Text, IntWritable, NullWritable> {
		public void map(LongWritable key, Text value, Context con) throws IOException, InterruptedException {
			...
			if(null==word||word.isEmpty()) {
				IntWritable outKey = new IntWritable(Integer.parseInt(words[1]));
